...
class SendDeliveryRecipient extends Mailable
{
    ...
    protected $toEmail;
    protected $content;
    protected $delivery_recipient_pdf;
    protected $cc_emails;
     ...
     * @return void
     */
    public function __construct($toEmail,$content, $delivery_recipient_pdf, $cc_emails = [], $bcc_emails = [])
    {
        $this->toEmail = $toEmail;
        $this->content = $content;
        $this->delivery_recipient_pdf = $delivery_recipient_pdf;
    ...
    public function build()
    {
        ...
        $email = $this->subject($subj)
					->markdown('emails.send_delivery_recipient')
                    // ->view('emails.report_invoice')
                    ->with($this->content)
                    ->attachData($this->delivery_recipient_pdf,'DeliveryReciept.pdf', [
