...
class SendInvoiceOfOrder extends Mailable
{
    ...
    public function build()
    {
        ...
        $subj = 'Invoice For Order # ' . $this->content['o_id'] . ' - By ' . config('app.name', 'Specialized Transport Systems');

        $email = $this->subject($subj)
					->markdown('emails.invoice_for_order')
					->with($this->content);
