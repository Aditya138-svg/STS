...
class sendConsolidateUnpaidOrders extends Mailable
{
    ...
    public function build()
    {
        ...
        $email = $this->subject('Consolidate Unpaid Orders')
					->markdown('emails.consolidateUnpaidOrders')
                    // ->view('emails.unpaidOrders')
                    ->with($this->content);
